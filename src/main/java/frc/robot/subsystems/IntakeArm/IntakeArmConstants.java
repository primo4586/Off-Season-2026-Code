...
public class IntakeArmConstants {
    ...
    public static final float REAL_KS = 5;
    public static final float REAL_KV = 4;
    public static final float REAL_KG = 2;
    //SIM PID constants
    ...
    public static final float SIM_KS = 5;
    public static final float SIM_KV = 4;
    public static final float SIM_KG = 2;
    //Physical Constants
    ...
    //TOLERANCE
    public static final Angle ARM_TOLERANCE = Degrees.of(1);
    //Telematry
